---
navTitle: 
navSubTitle: Optimizing Your Meteor App for Live Queries
...
> **Kadira’s Live Query Support**
> 
> We’ve recently introduced [Live Query monitoring](https://kadira.io/blog/product/meteor-live-query-monitoring-in-kadira) support to Kadira. I’ll use some terms and graphs from that for this article. 

<u>Let’s discuss some optimizations we can implement.</u>

### Try to fetch as little as possible

This is the rule of thumb you can apply for any app. But you can’t decide which publication to optimize until you go live or launch a load test. After that, you can use Kadira to find out which publications fetch a lot of data from MongoDB. Here’s how to [check this](https://cldup.com/HMW4ZQxrSI.gif):

* Go to Kadira’s Live Queries tab
